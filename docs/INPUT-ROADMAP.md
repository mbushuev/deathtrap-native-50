...
## Phase 5: XInput (implemented through 0.0.32)
...
- Pulse chalk's retail volatile action state only during one exact engine
  callback, never during synthetic render phases.
